...
for i,f in enumerate(F['filters']): 
    ...
    plt.scatter(pivwv, limits[f], zorder = 3, label = f.split('.')[-1], c=[c]) # --- plot pivot wavelength
    plt.text(pivwv, limits[f]+1.2, f.split('.')[-1], ha='center', va='center', fontsize=6)
