...
class survey():
    ...
    def add_field(self, field_name, filters = [], depths = {}, area = None, mask_file = None, depth_aperture_radius_arcsec = None, depth_aperture_radius_pixel = None, depth_aperture_significance = None, pixel_scale = None, detection_filters = None):

        self.fields[field_name] = Field()

        # --- taken from parent
        self.fields[field_name].survey_name = self.name
        self.fields[field_name].data_reference = self.data_reference
        self.fields[field_name].data_dir = self.data_dir
        ...
        self.fields[field_name].detection_filters = detection_filters
...
# --- entire field
# surveys['XDF'].add_field('XDF', filters, depths, depth_aperture_radius_pixel = 0.35/2.)
...
surveys['XDF'].add_field('dXDF', filters, depths, depth_aperture_radius_pixel = 0.35/2., area = 4.04, mask_file = 'hlsp_xdf_hst_deepest_flag_v1.fits', detection_filters = detection_filters)
